    ...
    <div className="min-h-screen bg-slate-50 pt-32 pb-24">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="flex flex-col md:flex-row justify-between items-center bg-slate-800 rounded-3xl p-8 text-white shadow-xl mb-10 gap-4">
          ...
          <Link href="/news" className="bg-primary-600 hover:bg-primary-500 font-bold px-6 py-3 rounded-xl flex items-center gap-2 transition-colors">
                    ...
                    <tr key={article.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="py-4 px-4 text-right">
                        <div className="flex justify-end gap-2">
                          <Link href={`/news?edit=${article.id}`} className="p-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 rounded-lg transition-colors">
                            <Pencil size={18} />
                          </Link>
