                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-100 dark:border-slate-700 flex items-center gap-3 cursor-pointer hover:border-primary-200 transition-colors" onClick={() => router.push(`/directory/${profile.reports_to}`)}>
